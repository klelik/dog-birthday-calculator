...
import videoBg from "./assets/dog-birthday-bg.mp4";
import dogLottie from "./assets/dog.json";
import sleepyDog from "./assets/sleepy dog.json";
        ...
        <div className="content hero-body">
          <div className="container has-text-centered">
            <div className="column is-6-widescreen is-offset-3-widescreen">
              ...
              >
                <h4 className="title has-text-centered mt-5 has-text-white	is-size-1	 ">
                  Dog Birthday Calculator
                </h4>
                <div className="lottie">
                  <Lotie loop={true} animationData={sleepyDog} />
                </div>
                <div className="column is-4 is-4-mobile mx-auto my-4 ">
                  <div className="field is-horizontal">
                    <div className="field-label mr-0 is-normal has-text-centered">
                      <label
                        className="label is-size-4 has-text-white"
                        htmlFor="name"
                      >
                        Dog's Name
                      </label>
